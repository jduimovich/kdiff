...
### This file generated at Sat Oct 12 00:07:18 UTC 2024
...
index 379711c5..d8c4726e 100644
...
+  newTag: v0.1.0-alpha7
 ...
 - behavior: replace
   literals:
diff --git a/components/workspaces/base/operator/config/metrics/kustomization.yaml b/components/workspaces/base/operator/config/metrics/kustomization.yaml
index 8713be40..ca9b49bd 100644
--- a/components/workspaces/base/operator/config/metrics/kustomization.yaml
+++ b/components/workspaces/base/operator/config/metrics/kustomization.yaml
@@ -4,8 +4,3 @@ resources:
 - monitor.yaml
...
diff --git a/components/workspaces/base/operator/config/metrics/monitor.yaml b/components/workspaces/base/operator/config/metrics/monitor.yaml
index 9819e65a..bcf096d7 100644
--- a/components/workspaces/base/operator/config/metrics/monitor.yaml
+++ b/components/workspaces/base/operator/config/metrics/monitor.yaml
@@ -25,3 +25,10 @@ spec:
     matchLabels:
...
index 4b038ccf..56205ece 100644
...
index 236c75a9..b0de9f0c 100644
...
index 078c3cb5..0c9205ec 100644
...
deleted file mode 100644
index ca9b49bd..00000000
--- a/components/workspaces/staging/base/operator/config/metrics/kustomization.yaml
+++ /dev/null
@@ -1,6 +0,0 @@
-apiVersion: kustomize.config.k8s.io/v1beta1
-kind: Kustomization
...
deleted file mode 100644
index 247719a6..00000000
--- a/components/workspaces/staging/base/operator/config/metrics/metrics-service.yaml
+++ /dev/null
@@ -1,23 +0,0 @@
-apiVersion: v1
-kind: Service
...
deleted file mode 100644
index bcf096d7..00000000
--- a/components/workspaces/staging/base/operator/config/metrics/monitor.yaml
+++ /dev/null
@@ -1,34 +0,0 @@
...
deleted file mode 100644
index 8ba34dd4..00000000
--- a/components/workspaces/staging/base/operator/config/metrics/service-account.yaml
+++ /dev/null
@@ -1,18 +0,0 @@
-apiVersion: v1
-kind: ServiceAccount
...
index 72a80f5a..900c4adf 100644
...
``` 
./commit-fa6ba777/production/components/workspaces/production/stone-prd-host1/kustomize.out.yaml
801a802
> data: {}
925c926
...
./commit-fa6ba777/production/components/workspaces/production/stone-prod-p01/kustomize.out.yaml
801a802
> data: {}
925c926
<         image: quay.io/konflux-workspaces/workspaces-operator:v0.1.0-alpha7
...
---
>         image: quay.io/konflux-workspaces/workspaces-server:v0.1.0-alpha6
./commit-fa6ba777/production/components/workspaces/production/stone-prod-p02/kustomize.out.yaml
801a802
> data: {}
925c926
<         image: quay.io/konflux-workspaces/workspaces-operator:v0.1.0-alpha7
...
<details> 
<summary>Kustomize Generated Diff (151 lines)</summary>  

``` 
./commit-fa6ba777/staging/components/workspaces/staging/stone-stage-p01/kustomize.out.yaml
801a802
> data: {}
./commit-fa6ba777/staging/components/workspaces/staging/stone-stg-rh01/kustomize.out.yaml
0a1,146
> apiVersion: apiextensions.k8s.io/v1
> kind: CustomResourceDefinition
> metadata:
...
index 622361ad..ada4fb9d 100644
...
+  - https://github.com/redhat-appstudio/perfscale/grafana/?ref=8ce467065bfb2b5af1c893c866d7a1cb99715af2 
```

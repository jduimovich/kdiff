...
### This file generated at Sat Apr 22 16:02:54 UTC 2023
...
<div>
<h3>1: Staging changes from 731f997 to 9cbf0e4 on Sat Apr 22 14:29:04 2023 </h3>  
...
<div>
<h3>1: Development changes from 731f997 to 9cbf0e4 on Sat Apr 22 14:29:04 2023 </h3>  
...
<div>
<h3>2: Staging changes from 550ba0f to 731f997 on Fri Apr 21 15:07:30 2023 </h3>  
...
<div>
<h3>2: Development changes from 550ba0f to 731f997 on Fri Apr 21 15:07:30 2023 </h3>  
...
<div>
<h3>3: Staging changes from 4f605ba to 550ba0f on Fri Apr 21 08:36:06 2023 </h3>  
...
diff --git a/argo-cd-apps/base/member/infra-deployments/monitoring-workload-grafana/kustomization.yaml b/argo-cd-apps/base/all-clusters/infra-deployments/monitoring-workload-grafana/kustomization.yaml
similarity index 57%
rename from argo-cd-apps/base/member/infra-deployments/monitoring-workload-grafana/kustomization.yaml
rename to argo-cd-apps/base/all-clusters/infra-deployments/monitoring-workload-grafana/kustomization.yaml
index 0fc5f2e..3513f29 100644
--- a/argo-cd-apps/base/member/infra-deployments/monitoring-workload-grafana/kustomization.yaml
+++ b/argo-cd-apps/base/all-clusters/infra-deployments/monitoring-workload-grafana/kustomization.yaml
...
diff --git a/argo-cd-apps/base/member/infra-deployments/monitoring-workload-grafana/monitoring-workload-grafana.yaml b/argo-cd-apps/base/all-clusters/infra-deployments/monitoring-workload-grafana/monitoring-workload-grafana.yaml
similarity index 100%
rename from argo-cd-apps/base/member/infra-deployments/monitoring-workload-grafana/monitoring-workload-grafana.yaml
rename to argo-cd-apps/base/all-clusters/infra-deployments/monitoring-workload-grafana/monitoring-workload-grafana.yaml
...
``` 
./commit-4f605ba/staging/app-of-apps-staging.yaml
651,655d650
<             matchExpressions:
...
./commit-550ba0f/staging/components/shared-resources/kustomize.out.yaml: (object: openshift-cluster-csi-drivers/shared-resource-csi-driver-node apps/v1, Kind=DaemonSet) container "hostpath" is privileged (check: privileged-container, remediation: Do not run your container as privileged unless it is required.)
...
./commit-550ba0f/staging/components/sprayproxy/staging/kustomize.out.yaml: (object: sprayproxy/sprayproxy apps/v1, Kind=Deployment) container "sprayproxy" does not have a read-only root file system (check: no-read-only-root-fs, remediation: Set readOnlyRootFilesystem to true in the container securityContext.)

./commit-550ba0f/staging/components/sprayproxy/staging/kustomize.out.yaml: (object: sprayproxy/sprayproxy apps/v1, Kind=Deployment) container "kube-rbac-proxy" does not have a read-only root file system (check: no-read-only-root-fs, remediation: Set readOnlyRootFilesystem to true in the container securityContext.)
...
./commit-550ba0f/staging/components/dora-metrics/staging/kustomize.out.yaml: (object: dora-metrics/exporter apps/v1, Kind=Deployment) container "container" does not have a read-only root file system (check: no-read-only-root-fs, remediation: Set readOnlyRootFilesystem to true in the container securityContext.)
...
<div>
<h3>3: Development changes from 4f605ba to 550ba0f on Fri Apr 21 08:36:06 2023 </h3>  
...
``` 
./commit-4f605ba/development/app-of-apps-development.yaml
559,563d558
<             matchExpressions:
<             - key: app.kubernetes.io/name
<               operator: NotIn
...
./commit-550ba0f/development/components/shared-resources/kustomize.out.yaml: (object: openshift-cluster-csi-drivers/shared-resource-csi-driver-node apps/v1, Kind=DaemonSet) container "hostpath" is privileged (check: privileged-container, remediation: Do not run your container as privileged unless it is required.)
...
<div>
<h3>4: Staging changes from c7a00b4 to 4f605ba on Fri Apr 21 08:22:02 2023 </h3>  
...
+  - monitoring-workload-prometheus
 components:
   - ../../../k-components/inject-infra-deployments-repo-details
diff --git a/argo-cd-apps/base/member/infra-deployments/monitoring-workload-prometheus/kustomization.yaml b/argo-cd-apps/base/all-clusters/infra-deployments/monitoring-workload-prometheus/kustomization.yaml
similarity index 57%
rename from argo-cd-apps/base/member/infra-deployments/monitoring-workload-prometheus/kustomization.yaml
rename to argo-cd-apps/base/all-clusters/infra-deployments/monitoring-workload-prometheus/kustomization.yaml
index f337ee3..08a0ccc 100644
--- a/argo-cd-apps/base/member/infra-deployments/monitoring-workload-prometheus/kustomization.yaml
+++ b/argo-cd-apps/base/all-clusters/infra-deployments/monitoring-workload-prometheus/kustomization.yaml
@@ -2,5 +2,3 @@ apiVersion: kustomize.config.k8s.io/v1beta1
 kind: Kustomization
 resources:
 - monitoring-workload-prometheus.yaml
-components:
-  - ../../../../k-components/deploy-to-member-cluster-merge-generator
diff --git a/argo-cd-apps/base/member/infra-deployments/monitoring-workload-prometheus/monitoring-workload-prometheus.yaml b/argo-cd-apps/base/all-clusters/infra-deployments/monitoring-workload-prometheus/monitoring-workload-prometheus.yaml
similarity index 100%
rename from argo-cd-apps/base/member/infra-deployments/monitoring-workload-prometheus/monitoring-workload-prometheus.yaml
rename to argo-cd-apps/base/all-clusters/infra-deployments/monitoring-workload-prometheus/monitoring-workload-prometheus.yaml
diff --git a/argo-cd-apps/base/member/infra-deployments/kustomization.yaml b/argo-cd-apps/base/member/infra-deployments/kustomization.yaml
index 476d672..70f8920 100644
--- a/argo-cd-apps/base/member/infra-deployments/kustomization.yaml
+++ b/argo-cd-apps/base/member/infra-deployments/kustomization.yaml
@@ -17,7 +17,6 @@ resources:
   - build-templates
...
``` 
./commit-c7a00b4/staging/app-of-apps-staging.yaml
741,745d740
<             matchExpressions:
<             - key: app.kubernetes.io/name
<               operator: NotIn
...
./commit-4f605ba/staging/components/shared-resources/kustomize.out.yaml: (object: openshift-cluster-csi-drivers/shared-resource-csi-driver-node apps/v1, Kind=DaemonSet) container "hostpath" is privileged (check: privileged-container, remediation: Do not run your container as privileged unless it is required.)
...
./commit-4f605ba/staging/components/sprayproxy/staging/kustomize.out.yaml: (object: sprayproxy/sprayproxy apps/v1, Kind=Deployment) container "sprayproxy" does not have a read-only root file system (check: no-read-only-root-fs, remediation: Set readOnlyRootFilesystem to true in the container securityContext.)

./commit-4f605ba/staging/components/sprayproxy/staging/kustomize.out.yaml: (object: sprayproxy/sprayproxy apps/v1, Kind=Deployment) container "kube-rbac-proxy" does not have a read-only root file system (check: no-read-only-root-fs, remediation: Set readOnlyRootFilesystem to true in the container securityContext.)
...
./commit-4f605ba/staging/components/dora-metrics/staging/kustomize.out.yaml: (object: dora-metrics/exporter apps/v1, Kind=Deployment) container "container" does not have a read-only root file system (check: no-read-only-root-fs, remediation: Set readOnlyRootFilesystem to true in the container securityContext.)
...
<div>
<h3>4: Development changes from c7a00b4 to 4f605ba on Fri Apr 21 08:22:02 2023 </h3>  
...
``` 
./commit-c7a00b4/development/app-of-apps-development.yaml
605,609d604
<             matchExpressions:
<             - key: app.kubernetes.io/name
<               operator: NotIn
...
./commit-4f605ba/development/components/shared-resources/kustomize.out.yaml: (object: openshift-cluster-csi-drivers/shared-resource-csi-driver-node apps/v1, Kind=DaemonSet) container "hostpath" is privileged (check: privileged-container, remediation: Do not run your container as privileged unless it is required.)

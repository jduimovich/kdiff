...
### This file generated at Mon May 22 12:26:19 UTC 2023
...
<div>
<h3>1: Staging changes from d978d759 to 48bf89de on Mon May 22 11:07:33 2023 </h3>  
...
<div>
<h3>1: Development changes from d978d759 to 48bf89de on Mon May 22 11:07:33 2023 </h3>  
...
<div>
<h3>2: Staging changes from 5095685c to d978d759 on Fri May 19 09:58:18 2023 </h3>  
...
<div>
<h3>2: Development changes from 5095685c to d978d759 on Fri May 19 09:58:18 2023 </h3>  
...
<div>
<h3>3: Staging changes from 5095685 to d978d75 on Fri May 19 09:58:18 2023 </h3>  
...
<div>
<h3>3: Development changes from 5095685 to d978d75 on Fri May 19 09:58:18 2023 </h3>  
...
<div>
<h3>4: Staging changes from ba0057ed to 5095685c on Fri May 19 09:47:24 2023 </h3>  
...
``` 
diff --git a/argo-cd-apps/base/tekton-ci/tekton-ci.yaml b/argo-cd-apps/base/tekton-ci/tekton-ci.yaml
index 1fd35dc0..f9e8335d 100644
--- a/argo-cd-apps/base/tekton-ci/tekton-ci.yaml
+++ b/argo-cd-apps/base/tekton-ci/tekton-ci.yaml
@@ -35,7 +35,7 @@ spec:
         kind: "ServiceAccount"
...
./commit-5095685c/staging/components/shared-resources/kustomize.out.yaml: (object: openshift-cluster-csi-drivers/shared-resource-csi-driver-node apps/v1, Kind=DaemonSet) container "hostpath" is privileged (check: privileged-container, remediation: Do not run your container as privileged unless it is required.)
...
./commit-5095685c/staging/components/dora-metrics/staging/kustomize.out.yaml: (object: dora-metrics/exporter apps/v1, Kind=Deployment) container "container" does not have a read-only root file system (check: no-read-only-root-fs, remediation: Set readOnlyRootFilesystem to true in the container securityContext.)
...
./commit-5095685c/staging/components/sprayproxy/staging/kustomize.out.yaml: (object: sprayproxy/sprayproxy apps/v1, Kind=Deployment) container "sprayproxy" does not have a read-only root file system (check: no-read-only-root-fs, remediation: Set readOnlyRootFilesystem to true in the container securityContext.)
...
<div>
<h3>4: Development changes from ba0057ed to 5095685c on Fri May 19 09:47:24 2023 </h3>  
...
./commit-5095685c/development/components/shared-resources/kustomize.out.yaml: (object: openshift-cluster-csi-drivers/shared-resource-csi-driver-node apps/v1, Kind=DaemonSet) container "hostpath" is privileged (check: privileged-container, remediation: Do not run your container as privileged unless it is required.)

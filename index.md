...
### This file generated at Sat Apr  8 04:01:35 UTC 2023
...
<div>
<h3>1: Staging changes from b3dfb4a to e4c4b03 on Thu Apr 6 13:55:01 2023 </h3>  
...
<div>
<h3>1: Development changes from b3dfb4a to e4c4b03 on Thu Apr 6 13:55:01 2023 </h3>  
...
<div>
<h3>2: Staging changes from c9bfe27 to b3dfb4a on Thu Apr 6 08:57:46 2023 </h3>  
...
<div>
<h3>2: Development changes from c9bfe27 to b3dfb4a on Thu Apr 6 08:57:46 2023 </h3>  
...
<div>
<h3>3: Staging changes from 27c063f to c9bfe27 on Thu Apr 6 08:45:43 2023 </h3>  
...
<div>
<h3>3: Development changes from 27c063f to c9bfe27 on Thu Apr 6 08:45:43 2023 </h3>  
...
<div>
<h3>4: Staging changes from 893dc5e to 27c063f on Thu Apr 6 08:22:50 2023 </h3>  
...
deleted file mode 100644
index 14321b3..0000000
--- a/components/spi/overlays/staging/stone-stg-m01/spi-aws-credentials-v2-path-patch.yaml
+++ /dev/null
@@ -1,7 +0,0 @@
----
-- op: replace
...
-  path: /spec/data/1/remoteRef/key
-  value: integrations-output/terraform-resources/stonesoups01ue1/stonesoup-infra-stage/spi-secrets-manager
diff --git a/components/spi/overlays/staging/stone-stg-m01/spi-vault-approle-spi-oauth-config-path.yaml b/components/spi/overlays/staging/stone-stg-m01/spi-vault-approle-spi-oauth-config-path.yaml
deleted file mode 100644
index 483244f..0000000
--- a/components/spi/overlays/staging/stone-stg-m01/spi-vault-approle-spi-oauth-config-path.yaml
+++ /dev/null
@@ -1,4 +0,0 @@
----
-- op: add
...
diff --git a/components/spi/overlays/staging/stone-stg-m01/spi-vault-approle-spi-operator-config-path.yaml b/components/spi/overlays/staging/stone-stg-m01/spi-vault-approle-spi-operator-config-path.yaml
deleted file mode 100644
index 4cc2cf5..0000000
--- a/components/spi/overlays/staging/stone-stg-m01/spi-vault-approle-spi-operator-config-path.yaml
+++ /dev/null
@@ -1,5 +0,0 @@
----
-- op: add
...
deleted file mode 100644
index 14321b3..0000000
--- a/components/spi/overlays/staging/stone-stg-rh01/spi-aws-credentials-v2-path-patch.yaml
+++ /dev/null
@@ -1,7 +0,0 @@
----
-- op: replace
...
-  path: /spec/data/1/remoteRef/key
-  value: integrations-output/terraform-resources/stonesoups01ue1/stonesoup-infra-stage/spi-secrets-manager
diff --git a/components/spi/overlays/staging/stone-stg-rh01/spi-vault-approle-spi-oauth-config-path.yaml b/components/spi/overlays/staging/stone-stg-rh01/spi-vault-approle-spi-oauth-config-path.yaml
deleted file mode 100644
index c6c1aea..0000000
--- a/components/spi/overlays/staging/stone-stg-rh01/spi-vault-approle-spi-oauth-config-path.yaml
+++ /dev/null
@@ -1,4 +0,0 @@
----
-- op: add
...
diff --git a/components/spi/overlays/staging/stone-stg-rh01/spi-vault-approle-spi-operator-config-path.yaml b/components/spi/overlays/staging/stone-stg-rh01/spi-vault-approle-spi-operator-config-path.yaml
deleted file mode 100644
index 36f2f3a..0000000
--- a/components/spi/overlays/staging/stone-stg-rh01/spi-vault-approle-spi-operator-config-path.yaml
+++ /dev/null
@@ -1,5 +0,0 @@
----
-- op: add
...
./commit-27c063f/staging/components/shared-resources/kustomize.out.yaml: (object: openshift-cluster-csi-drivers/shared-resource-csi-driver-node apps/v1, Kind=DaemonSet) container "hostpath" is privileged (check: privileged-container, remediation: Do not run your container as privileged unless it is required.)
...
./commit-27c063f/staging/components/sprayproxy/staging/kustomize.out.yaml: (object: sprayproxy/sprayproxy apps/v1, Kind=Deployment) container "sprayproxy" does not have a read-only root file system (check: no-read-only-root-fs, remediation: Set readOnlyRootFilesystem to true in the container securityContext.)

./commit-27c063f/staging/components/sprayproxy/staging/kustomize.out.yaml: (object: sprayproxy/sprayproxy apps/v1, Kind=Deployment) container "kube-rbac-proxy" does not have a read-only root file system (check: no-read-only-root-fs, remediation: Set readOnlyRootFilesystem to true in the container securityContext.)
...
./commit-27c063f/staging/components/dora-metrics/staging/kustomize.out.yaml: (object: dora-metrics/exporter apps/v1, Kind=Deployment) container "container" does not have a read-only root file system (check: no-read-only-root-fs, remediation: Set readOnlyRootFilesystem to true in the container securityContext.)
...
<div>
<h3>4: Development changes from 893dc5e to 27c063f on Thu Apr 6 08:22:50 2023 </h3>  
...
./commit-27c063f/development/components/shared-resources/kustomize.out.yaml: (object: openshift-cluster-csi-drivers/shared-resource-csi-driver-node apps/v1, Kind=DaemonSet) container "hostpath" is privileged (check: privileged-container, remediation: Do not run your container as privileged unless it is required.)

...
### This file generated at Mon Apr  3 20:02:44 UTC 2023
...
<div>
<h3>1: Staging changes from 249d757 to fa5fdaa on Mon Apr 3 19:25:18 2023 </h3>  
...
<div>
<h3>1: Development changes from 249d757 to fa5fdaa on Mon Apr 3 19:25:18 2023 </h3>  
...
<div>
<h3>2: Staging changes from a746b0c to 249d757 on Mon Apr 3 14:31:52 2023 </h3>  
...
<div>
<h3>2: Development changes from a746b0c to 249d757 on Mon Apr 3 14:31:52 2023 </h3>  
...
<div>
<h3>3: Staging changes from 1aa1296 to a746b0c on Mon Apr 3 14:12:59 2023 </h3>  
...
<div>
<h3>3: Development changes from 1aa1296 to a746b0c on Mon Apr 3 14:12:59 2023 </h3>  
...
<div>
<h3>4: Staging changes from 58e7c44 to 1aa1296 on Mon Apr 3 13:55:35 2023 </h3>  
...
``` 
./commit-58e7c44/staging/app-of-apps-staging.yaml
25,27d24
<         automated:
<           prune: true
<           selfHeal: true
...
./commit-1aa1296/staging/components/shared-resources/kustomize.out.yaml: (object: openshift-cluster-csi-drivers/shared-resource-csi-driver-node apps/v1, Kind=DaemonSet) container "hostpath" is privileged (check: privileged-container, remediation: Do not run your container as privileged unless it is required.)
...
./commit-1aa1296/staging/components/dora-metrics/staging/kustomize.out.yaml: (object: dora-metrics/exporter apps/v1, Kind=Deployment) container "container" does not have a read-only root file system (check: no-read-only-root-fs, remediation: Set readOnlyRootFilesystem to true in the container securityContext.)
...
./commit-1aa1296/staging/components/sprayproxy/staging/kustomize.out.yaml: (object: sprayproxy/sprayproxy apps/v1, Kind=Deployment) container "sprayproxy" does not have a read-only root file system (check: no-read-only-root-fs, remediation: Set readOnlyRootFilesystem to true in the container securityContext.)

./commit-1aa1296/staging/components/sprayproxy/staging/kustomize.out.yaml: (object: sprayproxy/sprayproxy apps/v1, Kind=Deployment) container "kube-rbac-proxy" does not have a read-only root file system (check: no-read-only-root-fs, remediation: Set readOnlyRootFilesystem to true in the container securityContext.)
...
<div>
<h3>4: Development changes from 58e7c44 to 1aa1296 on Mon Apr 3 13:55:35 2023 </h3>  
...
./commit-1aa1296/development/components/shared-resources/kustomize.out.yaml: (object: openshift-cluster-csi-drivers/shared-resource-csi-driver-node apps/v1, Kind=DaemonSet) container "hostpath" is privileged (check: privileged-container, remediation: Do not run your container as privileged unless it is required.)
